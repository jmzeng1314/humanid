...
#' @keywords geneAnno
#' @examples
#' #' keggAnnotation('TP53',fileName='TP53',multiple = F),keggAnnotation('TP53')



keggAnnotation <- function(geneLists=c(1,2,9),fileType='html',fileName='gene',multiple=T){
